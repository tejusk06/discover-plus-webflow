      ...
      (function(e) {
        ...
        var e0 = xe((Uy, jo) => {
          ...
          var FD = Object.create, _r = Object.defineProperty, AD = Object.getOwnPropertyDescriptor, Gn = Object.getOwnPropertyNames, SD = Object.getPrototypeOf, xD = Object.prototype.hasOwnProperty, ht = (e, r) => function() {
            ...
            r.prototype = { diff: function(n, u) {
              ...
              function w() {
                for (var N = -1 * c; N <= c; N += 2) {
                  var x = void 0, I = F[N - 1], P = F[N + 1], $2 = (P ? P.newPos : 0) - N;
                  I && (F[N - 1] = void 0);
                  var D = I && I.newPos + 1 < h, T = P && 0 <= $2 && $2 < g;
                  if (!D && !T) {
                    F[N] = void 0;
                    continue;
                  }
                  if (!D || T && I.newPos < P.newPos ? (x = s(P), p.pushComponent(x.components, void 0, true)) : (x = I, x.newPos++, p.pushComponent(x.components, true, void 0)), $2 = p.extractCommon(x, u, n, N), x.newPos + 1 >= h && $2 + 1 >= g)
            ...
            var f = { type: "line-suffix-boundary" }, F = { type: "break-parent" }, _ = { type: "trim" }, w = { type: "line", hard: true }, E = { type: "line", hard: true, literal: true }, N = { type: "line" }, x = { type: "line", soft: true }, I = t([w, F]), P = t([E, F]), $2 = { type: "cursor", placeholder: Symbol("cursor") };
            function D(C, o) {
              let d = [];
            ...
            r.exports = { concat: t, join: D, line: N, softline: x, hardline: I, literalline: P, group: n, conditionalGroup: p, fill: y, lineSuffix: c, lineSuffixBoundary: f, cursor: $2, breakParent: F, ifBreak: h, trim: _, indent: s, indentIfBreak: g, align: a, addAlignmentToDoc: T, markAsRoot: i, dedentToRoot: u, dedent: l, hardlineWithoutBreakParent: w, literallineWithoutBreakParent: E, label: m };
...
`)).parts;
            ...
            r.exports = { isConcat: n, getDocParts: u, willBreak: g, traverseDoc: l, findInDoc: y, mapDoc: p, propagateBreaks: f, removeLines: _, stripTrailingHardline: N, normalizeParts: P, normalizeDoc: $2, cleanDoc: I, replaceTextEndOfLine: T, replaceEndOfLine: D, canBreak: C };
            ...
            function N(x, I) {
              y = {};
              let P = I.printWidth, $2 = t(I.endOfLine), D = 0, T = [{ ind: c(), mode: h, doc: x }], m = [], C = false, o = [];
              for (; T.length > 0; ) {
            ...
            function _(E) {
              ...
              function I($2) {
                for (var D = [], T = 1; T < arguments.length; T++)
                  D[T - 1] = arguments[T];
                if (F($2)) {
                  var m = $2, C = (D[0] === I || D[0] === w) && g.test(m[0]) && y.test(m[1]), o = C ? x : N, d = o.get(m);
...
`);
          ...
          var Br, Nr, Et = ht({ "node_modules/tslib/tslib.es6.js"() {
            ...
            function i(g, c) {
              ...
              }, x = F ? a : t.apiDescriptor, I = l(c, { isCLI: F, colorsModule: w, levenshteinDistance: E }), P = new t.Normalizer(I, { logger: f, unknown: N, descriptor: x }), $2 = f !== false;
            ...
            function u(l, p) {
              let y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, h = (y.highlightCode || y.forceColor) && (0, r.shouldHighlight)(y), g = (0, r.getChalk)(y), c = s(g), f = ($2, D) => h ? $2(D) : D, F = l.split(a), { start: _, end: w, markerLines: E } = n(p, F, y), N = p.start && typeof p.start.column == "number", x = String(w).length, P = (h ? (0, r.default)(l, y) : l).split(a, w).slice(_, w).map(($2, D) => {
...
` + w.codeFrame, w;
            ...
            function l(f, F, _, w) {
              let E = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], N = arguments.length > 5 ? arguments[5] : void 0, { locStart: x, locEnd: I } = _, P = x(f), $2 = I(f);
...
`);
            ...
            function T(m, C) {
              let { hasBOM: o, text: d, options: v } = $2(m, y(C));
            ...
            r.exports = { formatWithCursor: T, parse(m, C, o) {
              let { text: d, options: v } = $2(m, y(C)), S = c.parse(d, v);
            ...
            "use strict";
            ne();
            var { getMaxContinuousCount: t, getStringWidth: s, getAlignmentSize: a, getIndentSize: n, skip: u, skipWhitespace: i, skipSpaces: l, skipNewline: p, skipToLineEnd: y, skipEverythingButNewLine: h, skipInlineComment: g, skipTrailingComment: c, hasNewline: f, hasNewlineInRange: F, hasSpaces: _, isNextLineEmpty: w, isNextLineEmptyAfterIndex: E, isPreviousLineEmpty: N, getNextNonSpaceNonCommentCharacterIndex: x, makeString: I, addLeadingComment: P, addDanglingComment: $2, addTrailingComment: D } = Ue();
...
`) && M.push({ hasLineBreak: false, cells: [] });
            ...
            function y(c, f, F) {
              let _ = c.getValue(), w = _.quasis.map((P) => P.value.raw), E = 0, N = w.reduce((P, $2, D) => D === 0 ? $2 : P + "@prettier-placeholder-" + E++ + "-id" + $2, ""), x = F(N, { parser: "scss" }, { stripTrailingHardline: true }), I = p(c, f);
              return h(x, _, I);
            }
            function h(c, f, F) {
...
`), P = I.length, $2 = f[_], D = P > 2 && I[0].trim() === "" && I[1].trim() === "", T = P > 2 && I[P - 1].trim() === "" && I[P - 2].trim() === "", m = I.every((o) => /^\s*(?:#[^\n\r]*)?$/.test(o));
                if (!N && /#[^\n\r]*$/.test(I[P - 1]))
                  return null;
                let C = null;
                m ? C = l(I) : C = h(x, { parser: "graphql" }, { stripTrailingHardline: true }), C ? (C = n(C, false), !E && D && F.push(""), F.push(C), !N && T && F.push("")) : !E && !N && D && F.push(""), $2 && F.push($2);
              }
              return ["`", t([a, s(a, F)]), a, "`"];
            }
            function l(p) {
            ...
            function y(h, g, c, f, F) {
              ...
              if (I.length === 0 && x.trim().length === 0)
                return "``";
              let P = new RegExp(N("(\\d+)"), "g"), $2 = 0, D = c(x, { parser: _, __onHtmlRoot(d) {
                $2 = d.children.length;
...
`;
            ...
            function w(N) {
              let { comments: x = "", pragmas: I = {} } = N, P = (0, t().default)(x) || r().EOL, $2 = "/**", D = " *", T = " */", m = Object.keys(I), C = m.map((d) => E(d, I[d])).reduce((d, v) => d.concat(v), []).map((d) => `${D} ${d}${P}`).join("");
              if (!x) {
                if (m.length === 0)
                  return "";
                if (m.length === 1 && !Array.isArray(I[m[0]])) {
                  let d = I[m[0]];
                  return `${$2} ${E(m[0], d)[0]}${T}`;
                }
              }
...
`) + _;
            ...
            function T(o, d, v) {
              let S = o.getValue(), b = o.getParentNode(), B = o.getParentNode(1), k = S !== b.body && (b.type === "IfStatement" || b.type === "WhileStatement" || b.type === "SwitchStatement" || b.type === "DoWhileStatement"), M = $2(d) && S.operator === "|>", R = m(o, v, d, false, k);
              if (k)
                return R;
              if (M)
                return i(R);
            ...
            function m(o, d, v, S, b) {
              ...
              if (M)
                ...
                let ie = $2(v) && q === "|>" ? o.call((ee) => m(ee, d, v, true, b), "right") : d("right");
                L = [R ? n : "", q, R ? " " : n, ie, J];
              }
            ...
            "use strict";
            ne();
            var { printComments: t, printDanglingComments: s, printCommentsSeparately: a } = et(), { builders: { line: n, hardline: u, softline: i, group: l, indent: p, conditionalGroup: y, fill: h, ifBreak: g, lineSuffixBoundary: c, join: f }, utils: { willBreak: F } } = qe(), { getLast: _, getPreferredQuote: w } = Ue(), { isJsxNode: E, rawText: N, isCallExpression: x, isStringLiteral: I, isBinaryish: P, hasComment: $2, CommentCheckFlags: D, hasNodeIgnoreComment: T } = Ke(), m = qt(), { willPrintOwnComments: C } = Eo(), o = (U) => U === "" || U === n || U === u || U === i;
            function d(U, Z, se) {
              let fe = U.getValue();
...
\r	`, ce = new RegExp("([" + ee + "]+)"), W = new RegExp("[^" + ee + "]"), K = (U) => U.replace(new RegExp("(?:^" + ce.source + "|" + ce.source + "$)"), "");
            ...
            function I(T, m, C) {
              ...
              if (o.elements.length === 0)
                ...
                d.push(u([v, i([a, q ? D(T, m, C, J) : [$2(T, m, "elements", C), J], t(T, m, true)]), a, S], { shouldBreak: R, id: M }));
              }
            ...
            "use strict";
            ne();
            var { printComments: t } = et(), { getLast: s, isNextLineEmptyAfterIndex: a, getNextNonSpaceNonCommentCharacterIndex: n } = Ue(), u = qt(), { isCallExpression: i, isMemberExpression: l, isFunctionOrArrowExpression: p, isLongCurriedCallExpression: y, isMemberish: h, isNumericLiteral: g, isSimpleCallArgument: c, hasComment: f, CommentCheckFlags: F, isNextLineEmpty: _ } = Ke(), { locEnd: w } = ut(), { builders: { join: E, hardline: N, group: x, indent: I, conditionalGroup: P, breakParent: $2, label: D }, utils: { willBreak: T } } = qe(), m = Ao(), { printMemberLookup: C } = So(), { printOptionalToken: o, printFunctionTypeParameters: d, printBindExpressionCallee: v } = ct();
            function S(b, B, k) {
              ...
              let Re;
              return se || we.length > 2 && we.some((Ne) => !Ne.arguments.every((Pe) => c(Pe, 0))) || Fe.slice(0, -1).some(T) || ke() ? Re = x(he) : Re = [T(z) || ge ? $2 : "", P([z, he])], D("member-chain", Re);
            }
            r.exports = S;
            ...
            function w(N, x, I) {
              let P = N.getValue(), $2 = N.getParentNode(), D = P.type === "NewExpression", T = P.type === "ImportExpression", m = F(N), C = n(P);
              if (C.length > 0 && (!T && !D && E(P, $2) || C.length === 1 && y(C[0], x.originalText) || !D && h(P, $2))) {
                let v = [];
                return g(N, () => {
                  v.push(I());
...
`) : F(W);
            ...
            r.exports = { printOpaqueType: D, printTypeAlias: T, printIntersectionType: m, printUnionType: C, printFunctionType: o, printTupleType: d, printIndexedAccessType: v, shouldHugType: $2, printJSDocType: S };
            ...
            function f(x, I) {
              return x.getNode().type !== "ExpressionStatement" ? false : x.call(($2) => F($2, I), "expression");
            }
            function F(x, I) {
              let P = x.getValue();
              switch (P.type) {
              ...
              return s(x, I) ? true : n(P) ? x.call(($2) => F($2, I), ...a(x, P)) : false;
            }
            function _(x, I, P) {
              return g(x, I, P, "body");
            }
            ...
            function g(c, f, F) {
              ...
              let x = [];
              if (w && c.each((I, P, $2) => {
                x.push(F()), (P < $2.length - 1 || E || N) && (x.push(a), l(I.getValue(), f) && x.push(a));
              ...
              switch (be.type) {
                ...
                case "IfStatement": {
                  ...
                  if (Se.push(Oe), be.alternate) {
                    let Je = E(be.consequent, N.Trailing | N.Line) || $2(be), Te = be.consequent.type === "BlockStatement" && !Je;
...
` || x === "\r") && (w && E.push([_, N]), f = "initial", w = false);
            ...
            function F(x, I) {
              var P, $2, D, T;
              let m = x.getValue(), C = (P = x.getParentNode(0)) !== null && P !== void 0 ? P : {}, o = ($2 = (D = (T = C.children) !== null && T !== void 0 ? T : C.body) !== null && D !== void 0 ? D : C.parts) !== null && $2 !== void 0 ? $2 : [], d = o.indexOf(m);
              return d !== -1 && o[d + I];
            }
            function _(x) {
            ...
            function f(P, $2, D) {
              ...
              switch (T.kind) {
                case "Document": {
                  let m = [];
                  return P.each((C, o, d) => {
                    m.push(D()), o !== d.length - 1 && (m.push(s), p($2.originalText, C.getValue(), c) && m.push(s));
                  }, "definitions"), [...m, s];
                }
...
`);
                ...
                case "ObjectTypeDefinition":
                  return [D("description"), T.description ? s : "", T.kind === "ObjectTypeExtension" ? "extend " : "", "type ", D("name"), T.interfaces.length > 0 ? [" implements ", ...N(P, $2, D)] : "", F(P, D, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $2, D, "fields"))]), s, "}"] : ""];
                ...
                case "InterfaceTypeDefinition":
                  return [D("description"), T.description ? s : "", T.kind === "InterfaceTypeExtension" ? "extend " : "", "interface ", D("name"), T.interfaces.length > 0 ? [" implements ", ...N(P, $2, D)] : "", F(P, D, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $2, D, "fields"))]), s, "}"] : ""];
                case "FragmentSpread":
            ...
            function _(P, $2, D, T) {
              return P.map((m, C, o) => {
                let d = D();
                return C < o.length - 1 && p($2.originalText, m.getValue(), c) ? [d, s] : d;
              }, T);
            }
            function w(P) {
...
`) && ($2.value = $2.value.trim());
            ...
            function g(E, N) {
              let x = "non-cjk", I = "cj-letter", P = "k-letter", $2 = "cjk-punctuation", D = [], T = (N.proseWrap === "preserve" ? E : E.replace(new RegExp(`(${n})
(${n})`, "g"), "$1$2")).split(/([\t\n ]+)/);
...
` : " " });
                ...
                for (let [v, S] of d.entries())
                  if (!((v === 0 || v === d.length - 1) && S === "")) {
                    ...
                    m(h.test(S) ? { type: "word", value: S, kind: $2, hasLeadingPunctuation: true, hasTrailingPunctuation: true } : { type: "word", value: S, kind: y.test(S) ? P : I, hasLeadingPunctuation: false, hasTrailingPunctuation: false });
                  }
              }
              return D;
              function m(C) {
                let o = t(D);
                o && o.type === "word" && (o.kind === x && C.kind === I && !o.hasTrailingPunctuation || o.kind === I && C.kind === x && !C.hasLeadingPunctuation ? D.push({ type: "whitespace", value: " " }) : !d(x, $2) && ![o.value, C.value].some((v) => /\u3000/.test(v)) && D.push({ type: "whitespace", value: "" })), D.push(C);
                function d(v, S) {
...
` + N.value, position: { start: E.position.start, end: N.position.end } }));
            ...
            function f(w, E) {
              return a(w, (N, x, I) => {
                ...
                if (N.type !== "text")
                  return N;
                let { value: $2 } = N;
                return P.type === "paragraph" && (x === 0 && ($2 = $2.trimStart()), x === P.children.length - 1 && ($2 = $2.trimEnd())), { type: "sentence", position: N.position, children: n($2, E) };
              });
            }
            function F(w, E) {
              return a(w, (N, x, I) => {
            ...
            "use strict";
            ne();
            var t = Po(), { getLast: s, getMinNotPresentContinuousCount: a, getMaxContinuousCount: n, getStringWidth: u, isNonEmptyArray: i } = Ue(), { builders: { breakParent: l, join: p, line: y, literalline: h, markAsRoot: g, hardline: c, softline: f, ifBreak: F, fill: _, align: w, indent: E, group: N, hardlineWithoutBreakParent: x }, utils: { normalizeDoc: I, replaceTextEndOfLine: P }, printer: { printDocToString: $2 } } = qe(), D = lg(), { insertPragma: T } = ko(), { locStart: m, locEnd: C } = Io(), o = cg(), d = pg(), { getFencedCodeBlockValue: v, hasGitDiffFriendlyOrderedList: S, splitText: b, punctuationPattern: B, INLINE_NODE_TYPES: k, INLINE_NODE_WRAPPER_TYPES: M, isAutolink: R } = iu(), q = /* @__PURE__ */ new Set(["importExport"]), J = ["heading", "tableCell", "link", "wikiLink"], L = /* @__PURE__ */ new Set(["listItem", "definition", "footnoteDefinition"]);
            function Q(oe, H, pe) {
              let X = oe.getValue();
              if (ge(oe))
...
`);
            ...
            r.exports = { htmlTrim: w, htmlTrimPreserveIndentation: N, hasHtmlWhitespace: $2, getLeadingAndTrailingHtmlWhitespace: P, canHaveInterpolation: d, countChars: Ne, countParents: fe, dedentString: Re, forceBreakChildren: q, forceBreakContent: R, forceNextEmptyLine: M, getLastDescendant: ie, getNodeCssStyleDisplay: he, getNodeCssStyleWhiteSpace: we, hasPrettierIgnore: T, inferScriptParser: K, isVueCustomBlock: H, isVueNonHtmlBlock: X, isVueScriptTag: De, isVueSlotAttribute: le, isVueSfcBindingsAttribute: Ae, isVueSfcBlock: pe, isDanglingSpaceSensitiveNode: k, isIndentationSensitiveNode: S, isLeadingSpaceSensitiveNode: b, isPreLikeNode: se, isScriptLikeTag: o, isTextLikeNode: C, isTrailingSpaceSensitiveNode: B, isWhitespaceSensitiveNode: v, isUnknownNamespace: c, preferHardlineAsLeadingSpaces: J, preferHardlineAsTrailingSpaces: L, shouldPreserveContent: D, unescapeQuoteEntities: Pe, getTextValueParts: Ee };
...
` && ++_ == h)); )
            ...
            "use strict";
            ne();
            var { ParseSourceSpan: t } = Ag(), { htmlTrim: s, getLeadingAndTrailingHtmlWhitespace: a, hasHtmlWhitespace: n, canHaveInterpolation: u, getNodeCssStyleDisplay: i, isDanglingSpaceSensitiveNode: l, isIndentationSensitiveNode: p, isLeadingSpaceSensitiveNode: y, isTrailingSpaceSensitiveNode: h, isWhitespaceSensitiveNode: g, isVueScriptTag: c } = Rt(), f = [_, w, N, I, P, T, $2, D, m, x, C];
            function F(o, d) {
              for (let v of f)
                v(o, d);
              return o;
...
` + a.replace(/^\s*\n/, "");
            ...
            function P(L, Q) {
              return o(L) ? $2(L.parent, Q) : d(L) ? q(L.next) : "";
            }
            function $2(L, Q) {
            ...
            r.exports = { printClosingTag: E, printClosingTagStart: N, printClosingTagStartMarker: $2, printClosingTagEndMarker: D, printClosingTagSuffix: P, printClosingTagEnd: x, needsToBorrowLastChildClosingTagEndMarker: C, needsToBorrowParentClosingTagStartMarker: o, needsToBorrowPrevClosingTagEndMarker: m, printOpeningTag: k, printOpeningTagStart: M, printOpeningTagPrefix: R, printOpeningTagStartMarker: q, printOpeningTagEndMarker: J, needsToBorrowNextOpeningTagStartMarker: d, needsToBorrowParentOpeningTagEndMarker: S };
...
` || $2 === "\f" || $2 === "\r";
                ...
                function P() {
                  var $2 = false, D, T, m, C, o = {}, d, v, S, b, B;
                  for (C = 0; C < F.length; C++)
                    d = F[C], v = d[d.length - 1], S = d.substring(0, d.length - 1), b = parseInt(S, 10), B = parseFloat(S), g.test(S) && v === "w" ? ((D || T) && ($2 = true), b === 0 ? $2 = true : D = b) : c.test(S) && v === "x" ? ((D || T || m) && ($2 = true), B < 0 ? $2 = true : T = B) : g.test(S) && v === "h" ? ((m || T) && ($2 = true), b === 0 ? $2 = true : m = b) : $2 = true;
                  $2 ? a && a.error && a.error("Invalid srcset descriptor found in '" + t + "' at '" + d + "'.") : (o.url = f, D && (o.w = D), T && (o.d = T), m && (o.h = m), x.push(o));
                }
              };
            });
            ...
            function T(m, C, o) {
              ...
              return m.map((S, b) => {
                ...
                return J && (g(B.prev) ? k.push(i, i) : J === i ? k.push(i) : c(B.prev) ? M.push(J) : M.push(a("", u, { groupId: v[b - 1] }))), L && (g(B) ? c(B.next) && q.push(i, i) : L === i ? c(B.next) && q.push(i) : R.push(L)), [...k, s([...M, s([$2(S, C, o), ...R], { id: v[b] })]), ...q];
              }, "children");
            }
...
`).map((B) => B.slice(v));
            ...
            function g(f, F, _) {
              ...
              return [N, h(_.tabWidth, [I, c(f, F, _), _.trailingComma === "none" ? "" : t(","), p(w) ? [n, u(n, f.map(F, "endComments"))] : ""]), $2 ? "" : I, x];
            }
            function c(f, F, _) {
              let w = f.getValue();
            ...
            function _(x, I, P, $2, D) {
              ...
              if (C)
                return [": ", F(2, S)];
              if (l(m) || !f(T.content))
                return ["? ", F(2, d), a, u("", P.map($2, "value", "leadingComments").map((q) => [q, a])), ": ", F(2, S)];
...
`);
            ...
            function w(E, N, x) {
              let I = E.getValue(), P = h(E, (C) => F(C, ["sequence", "mapping"])), $2 = f(E), D = [I.type === "blockFolded" ? ">" : "|"];
              ...
              for (let [C, o] of T.entries())
                C === 0 && m.push(n), m.push(a(y(u(i, o)))), C !== T.length - 1 ? m.push(o.length === 0 ? n : p(l)) : I.chomping === "keep" && $2 && m.push(s(o.length === 0 ? n : l));
  ...
  // src/utils/fetchOpportunities.js
  init_live_reload();
  var fetchOpportunities = async () => {
    try {
      ...
      if (cachedData && cachedTimestamp) {
        ...
        const ageInSeconds = ageInMilliseconds / 1e3;
        if (ageInSeconds < 2) {
  ...
  var fetchOpportunities_default = fetchOpportunities;

  // src/utils/showAlert.js
  init_live_reload();
  var showAlert = (alertText) => {
  ...
  var showAlert_default = showAlert;

  // src/utils/updateSearchesOnAirtable.js
  init_live_reload();
  var updateSearchesOnAirtable = (updatedSearchesString) => {
    ...
    fetch(`https://discover-plus-server.herokuapp.com/api/v1/user/anyid`, requestOptions).then((response) => response.text()).then((result) => {
      return;
    }).catch((error) => console.log("error", error));
  };
  var updateSearchesOnAirtable_default = updateSearchesOnAirtable;

  // src/index.js
  var populateDateFromCms = () => {
    ...
    const likeOpportunityUpdate = async (airtableId, likedIcon) => {
      const updateOpportunityOnAirtable = (updatedLikedOpportunitiesArray2) => {
        ...
        var raw = JSON.stringify({
          event: "liked.updated",
          id: userAirtableId,
          payload: updatedLikedOpportunitiesArray2
        });
        var requestOptions = {
          method: "PUT",
          headers: myHeaders,
        ...
        fetch(`https://discover-plus-server.herokuapp.com/api/v1/user/11`, requestOptions).then((response) => response.text()).then((result) => {
          return;
        }).catch((error) => console.log("error", error));
      };
      const likedOpportunities = localStorage.getItem("likedOpportunities");
    ...
    const createItem = (eachOpp, templateElement, likedOpportunities) => {
      ...
      const populateFields = () => {
        ...
        if (likedOpportunities) {
          ...
          setTimeout(() => {
            const likedOpportunities2 = localStorage.getItem("likedOpportunities");
            if (likedOpportunities2?.includes(eachOpp.airtableId) && likeWrap) {
              likeWrap.querySelector('[discover-element="liked-icon"]').style.color = "#E12122";
            }
          }, 2e3);
        }
  ...
  var moveFields = () => {
    ...
    fieldCategories.forEach((eachFieldCategory) => {
      fields.forEach((eachField) => {
        if (eachFieldCategory.querySelector(".home_filters_checkbox-label").innerHTML === eachField.querySelector(".home_filters_field-category").innerHTML) {
          if (eachFieldCategory.querySelector(".home_filters_checkbox-label").innerHTML === eachField.querySelector(".home_filters_checkbox-label").innerHTML) {
    ...
    fieldsCheckboxesWrapper?.addEventListener("click", (e) => {
      ...
      if (e.target.classList.contains("home_filters_category-overlay")) {
        ...
        const childCheckboxes = categoryCheckbox.parentElement.parentElement.querySelector(".home_filters_fields-wrap").querySelectorAll(".home_filters_checkbox-field");
        ...
        const categoryCheckbox = childCheckbox.closest(".home_filters_item-wrap").querySelector(".home_filters_category-holder").querySelector(".home_filters_checkbox-field");
        childCheckbox.click();
        if (childCheckbox.classList.contains("fs-cmsfilter_active")) {
          ...
          const childCheckboxes = childCheckbox.closest(".home_filters_fields-wrap").querySelectorAll(".home_filters_checkbox-field");
    ...
    const locationBoxes = document.querySelector(".home_filters_locations-wrapper").querySelectorAll(".home_filter_checkbox-region-wrap");
      ...
      eachLocationBoxOverlay.addEventListener("click", (e) => {
        if (e.target.parentElement.classList.contains("home_filter_checkbox-region-wrap")) {
          ...
          locationCategoriesWrap.forEach((eachLocationCategory) => {
            const eachLocationCategoryName = eachLocationCategory.querySelector(".home_filters_category-holder").querySelector(".home_filters_checkbox-label").innerHTML;
    ...
    locationsCheckboxesWrapper?.addEventListener("click", (e) => {
      ...
      if (e.target.classList.contains("home_filters_category-overlay")) {
        ...
        categoryCheckbox.click();
        const childCheckboxes = categoryCheckbox.parentElement.parentElement.querySelector(".home_filters_location-wrap").querySelectorAll(".home_filters_checkbox-field");
        if (categoryCheckbox.classList.contains("fs-cmsfilter_active")) {
          childCheckboxes.forEach((eachChildCheckbox) => {
            if (!eachChildCheckbox.classList.contains("fs-cmsfilter_active")) {
              eachChildCheckbox.click();
          ...
          locationBoxes.forEach((eachLocationBoxOverlay) => {
            ...
            if (categoryCheckboxName === actualCheckbox.querySelector(".home_filters_checkbox-label").innerHTML) {
        ...
        if (childCheckbox.classList.contains("fs-cmsfilter_active")) {
          ...
          const childCheckboxes = childCheckbox.closest(".home_filters_location-wrap").querySelectorAll(".home_filters_checkbox-field");
          let allUnchecked = true;
          childCheckboxes.forEach((eachChildCheckbox) => {
            if (eachChildCheckbox.classList.contains("fs-cmsfilter_active")) {
              allUnchecked = false;
    ...
    categoryHolders.forEach((eachCategoryHolder) => {
      ...
      eachCategoryCheckbox.addEventListener("click", (e) => {
        if (e.target.tagName === "INPUT") {
          if (!e.target.checked) {
            const fieldCheckboxesWrap = e.target.closest(".home_filters_item-wrap").querySelector(".home_filters_fields-wrap");
            const locationCheckboxesWrap = e.target.closest(".home_filters_item-wrap").querySelector(".home_filters_location-wrap");
            ...
            if (locationCheckboxesWrap) {
              const categoryCheckboxName = e.target.closest(".home_filters_item-wrap").querySelector(".home_filters_category-holder").querySelector(".home_filters_checkbox-label").innerHTML;
              locationBoxes.forEach((eachLocationBoxOverlay) => {
                const actualCheckbox = eachLocationBoxOverlay.parentElement.querySelector(
                  ".home_filter_checkbox-region"
                );
  ...
  var saveSearches = () => {
    ...
    saveSearchNonMembers?.addEventListener("click", () => {
      showAlert_default("You need to Login In to save a search");
    ...
    saveSearchButton?.addEventListener("click", () => {
      if (window.location.search === "") {
        showAlert_default("Select atleast one filter to save search");
      } else {
    ...
    saveSearchSubmit.addEventListener("click", () => {
      ...
      if (localSavedSearches === "undefined" || localSavedSearches === "") {
        ...
        updateSearchesOnAirtable_default(savedSearchesString);
        saveSearchSection.style.display = "none";
        saveSearchFormInput.value = "";
        showAlert_default("Search Saved");
      } else {
        ...
        if (searchNameUnique) {
          ...
          showAlert_default("A saved search already exists with the same name.");
        }
      }
    });
  };
  var showSelectedFilterText = () => {
    document.addEventListener("click", function(e) {
      if (e.target.type === "checkbox") {
