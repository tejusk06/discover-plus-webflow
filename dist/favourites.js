...
`);
      ...
      savedSearchesArray.forEach((eachSavedSearch) => {
        ...
        const populateFilterValues = () => {
          if (filterValues.type) {
            newSearch.querySelector('[discover-element="search-type"]').innerHTML = filterValues.type.replaceAll(",", ", ");
          } else {
            newSearch.querySelector('[discover-element="search-type"]').parentElement.style.display = "none";
          }
          if (filterValues["field-category"]) {
            newSearch.querySelector('[discover-element="search-field-category"]').innerHTML = filterValues["field-category"].replaceAll(",", ", ");
          } else {
          ...
          if (filterValues.field) {
            newSearch.querySelector('[discover-element="search-field"]').innerHTML = filterValues.field.replaceAll(",", ", ");
          } else {
            newSearch.querySelector('[discover-element="search-field"]').parentElement.style.display = "none";
          }
          if (filterValues.grade) {
            newSearch.querySelector('[discover-element="search-grade"]').innerHTML = filterValues.grade.replaceAll(",", ", ");
          } else {
            newSearch.querySelector('[discover-element="search-grade"]').parentElement.style.display = "none";
          }
          if (filterValues.timetable) {
            newSearch.querySelector('[discover-element="search-timetable"]').innerHTML = filterValues.timetable.replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues["location-type"]) {
            newSearch.querySelector('[discover-element="search-location-type"]').innerHTML = filterValues["location-type"].replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues["location-category"]) {
            newSearch.querySelector('[discover-element="search-location-category"]').innerHTML = filterValues["location-category"].replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues.location) {
            newSearch.querySelector('[discover-element="search-location"]').innerHTML = filterValues.location.replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues.deadline) {
            newSearch.querySelector('[discover-element="search-deadline"]').innerHTML = filterValues.deadline.replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues.duration) {
            newSearch.querySelector('[discover-element="search-duration"]').innerHTML = filterValues.duration.replaceAll(",", ", ");
          } else {
            newSearch.querySelector(
          ...
          if (filterValues.cost) {
            newSearch.querySelector('[discover-element="search-cost"]').innerHTML = filterValues.cost.replaceAll(",", ", ");
          } else {
            newSearch.querySelector('[discover-element="search-cost"]').parentElement.style.display = "none";
          }
        ...
        const deleteSearch = () => {
          newSearch.querySelector('[discover-element="delete-search"]').addEventListener("click", () => {
            ...
            const savedSearches2 = localStorage.getItem("savedSearches");
            const savedSearchesArray2 = JSON.parse(savedSearches2);
            const filteredSearchesArray = savedSearchesArray2.filter((eachSavedSearch2) => {
              if (eachSavedSearch2.name === searchName) {
                return false;
              }
              return true;
            });
            ...
            updateSearchesOnAirtable_default(filteredSearchesString);
  ...
  var likeOpportunityUpdate = async (airtableId, likedIcon) => {
  ...
  var createItem = (eachOpp, templateElement, likedOpportunities) => {
